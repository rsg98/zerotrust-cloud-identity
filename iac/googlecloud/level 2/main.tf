...
resource "google_service_account_iam_member" "workload_identity_user_binding" {
  ...
  member             = "principalSet://iam.googleapis.com/projects/${var.gcp_project_number}/locations/global/workloadIdentityPools/${google_iam_workload_identity_pool.okta_pool.workload_identity_pool_id}/providers/${google_iam_workload_identity_pool_provider.okta_provider.workload_identity_pool_provider_id}/attribute.group/gcp_terraform_users"
}
